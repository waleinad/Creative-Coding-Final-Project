function Jatekos() {
  ...
  this.kep = [];
  this.kep[0] = loadImage("img/km_0.png");
  this.kep[1] = loadImage("img/km_1.png");
  this.kep[2] = loadImage("img/km_2.png");
  this.kep[3] = loadImage("img/km_3.png");
  this.kep[4] = loadImage("img/km_4.png");
  this.kep[5] = loadImage("img/km_5.png");
  this.kep[6] = loadImage("img/nm_0.png");
  this.kep[7] = loadImage("img/nm_1.png");
  this.kep[8] = loadImage("img/nm_2.png");
  this.kep[9] = loadImage("img/nm_3.png");
  this.kep[10] = loadImage("img/nm_4.png");
  this.kep[11] = loadImage("img/nm_5.png");
  this.kep[12] = loadImage("img/nm_6.png");
  this.kep[13] = loadImage("img/kmb_0.png");
  this.kep[14] = loadImage("img/kmb_1.png");
  this.kep[15] = loadImage("img/kmb_2.png");
  this.kep[16] = loadImage("img/kmb_3.png");
  this.kep[17] = loadImage("img/kmb_3.png");
  this.kep[18] = loadImage("img/kmb_5.png");
  this.kep[19] = loadImage("img/nmb_0.png");
  this.kep[20] = loadImage("img/nmb_1.png");
  this.kep[21] = loadImage("img/nmb_2.png");
  this.kep[22] = loadImage("img/nmb_3.png");
  this.kep[23] = loadImage("img/nmb_4.png");
  this.kep[24] = loadImage("img/nmb_5.png");
  this.kep[25] = loadImage("img/nmb_6.png");
  this.kep[26] = loadImage("img/mh.png");
