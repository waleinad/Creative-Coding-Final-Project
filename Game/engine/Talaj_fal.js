function Talaj_fal() {
  ...
  this.p_kcs = loadImage("img/kcs.png");
  this.p_kozcs = loadImage("img/kozcs.png");
  this.p_ncs = loadImage("img/ncs.png");
  this.p_kerd = loadImage("img/kerd.png");
  this.p_t = loadImage("img/t.png");
  this.p_l = loadImage("img/l.png");
  this.p_padlo = loadImage("img/padlo.png");
  this.p_kerdu = loadImage("img/kerd_utve.png");
  this.p_kerds = loadImage("img/kerd_s.png");
  this.ptt = loadImage("img/tt.png");
