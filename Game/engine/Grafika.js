function Grafika() {
  ...
  this.p_kf = loadImage("img/kf.png");
  this.p_kozf = loadImage("img/kozf.png");
  this.p_nf = loadImage("img/nf.png");
  this.p_kdb = loadImage("img/kdb.png");
  this.p_ndb = loadImage("img/ndb.png");
  this.p_kb = loadImage("img/kb.png");
  this.p_kozb = loadImage("img/kozb.png");
  this.p_nb = loadImage("img/nb.png");
  this.penz = loadImage("img/money_1.png");
  ...
  this.kfmegjelenites = function() {
    ...
    text("SCORE", this.pontx - 40, 55);
    text(nf(this.pont, 6, 0), this.pontx - 42, 80);

    image(this.penz, this.eremx, 68, 42, 30);
    text("×", this.eremx + 12, 80);
    text(nf(this.erem, 2, 0), this.eremx + 32, 80);

    text("LEVEL", this.vilagx - 20, 55);
