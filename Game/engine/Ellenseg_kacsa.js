function Ellenseg_kacsa() {
  ...
  this.ki = true;
  this.kep = [];
  this.kep[1] = loadImage("img/kacsa_teknos_1.png");
  this.kep[2] = loadImage("img/kacsa_teknos_2.png");
  this.kep[3] = loadImage("img/kacsa_teknos_3.png");
  this.kep[4] = loadImage("img/kacsa_teknos_4.png");
  this.kep[5] = loadImage("img/kacsa_teknos_5.png");
